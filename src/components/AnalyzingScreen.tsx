...
import { Search, Newspaper, Code, TrendingUp, Database } from 'lucide-react'
...
const analysisSteps = [
  {
    id: 'scanning',
    icon: Search,
    message: `Decrypting Signals...`,
    duration: 2500
  },
  {
    id: 'news',
    icon: Newspaper,
    message: 'Scanning Digital Footprint...',
    duration: 3500
  },
  {
    id: 'jobs',
    icon: TrendingUp,
    message: 'Generating Strategic Intel...',
    duration: 3000
  },
  {
    id: 'tech',
    ...
    >
      <div className="max-w-2xl w-full mx-4">
        <motion.div
          ...
          className="bg-gray-900/90 backdrop-blur border border-gray-800 rounded-2xl p-4"
        >
          {/* Header */}
          <div className="text-center mb-4">
            <motion.div
              ...
              className="w-14 h-14 flex items-center justify-center mx-auto mb-4 shadow-2xl"
            >
              <img 
                src="/icon.webp" 
                alt="PitchIntel Logo"
